...
from .yk_s001 import BEHAVIOR as YK_S001_BEHAVIOR
...
_DEFINITIONS = {
    ...
    ProtocolFamily.YK_S001: ProtocolDefinition(
        spec=ProtocolSpec(
            packet_prefix=None,
            command_set=ProtocolCommandSet.YK_S001,
        ),
        behavior=YK_S001_BEHAVIOR,
    ),
}
